        ...
        <div className='bg-dark-purple font-ntr'>
            ...
            <div className="flex vw-70">
                <div className="font-castorgate font-white font-size-64 flex column end-column margin-global-left margin-bottom-50 title-margin">
                    <div className="heading-margin">Hi I'm <span className="font-pink">Ricky</span></div>
                    <div>I'm a <span className="font-pink">Web Developer</span></div>
                </div>
            </div>
            ...
            <div id="projects" className="flex column center-row">
                <div className="vh-80 margin-global-left font-size-20 flex overflow-x-hidden vw-70">
                    <div className="flex space-between-column padding-top-5 width-100 height-70" id="project1">
                    ...
                    <div className="flex space-between-column padding-top-5 width-100 height-70" id="project2">
                        <div className="flex column space-between-column vw-28">
                            <div className="font-pink">CHRYSALLIS</div>
                            <div className="font-white desc-padding"><span className="font-pink">Custom-built IOT System</span> made to <span className="font-pink">automatically</span> turn lights on and off at certain times and track assembly line's outputs</div>
                            <div className="flex space-evenly-column font-green">
                                <a href="https://www.linkedin.com/posts/ricky-dave-madrid-aa4ba6149_esp32-microcontroller-microcontrollers-activity-6764364158231306240-QK32?utm_source=linkedin_share&utm_medium=member_desktop_web" className="transition-navbar hover" target="_blank">DEMO</a>
                            </div>
                        </div>
                    ...
                    <div className="flex space-between-column padding-top-5 width-100 height-70" id="project3">
                        <div className="flex column space-between-column vw-28">
                            ...
                            <div className="font-white desc-padding">Create and visualize  <span className="font-pink">cashflow data</span>. Combine and/or compare different cashflow scenarios for better context along with <span className="font-pink">third-party integration</span> with popular acccounting softwares.
                            </div>
                            <div className="flex space-evenly-column font-green">
                                <a className="transition-navbar hover" href="https://moolamore.com" target="_blank">SITE</a>
                            </div>
                        </div>
            ...
            <div id="contact" className="flex center-column font-white font-size-24 bottom-page-padding">
                <div className="flex row-column center-row font-size-20 vw-70 overflow-x-hidden padding-top-10 padding-bottom-10 space-around-column">
                    <div className="font-size-24 text-align-justify contact-vw-53">
                        <p>
                        I enjoy anything related to <span className="font-pink">Development</span> and I’m always on the lookout for <span className="font-pink">New and Interesting Opportunities</span>. From building out <span className="font-pink">IOT systems</span>, custom-made <span className="font-pink">Automated Systems</span>, making <span className="font-pink">Web Applications</span>, and designing <span className="font-pink">Websites</span>, I’m always up for new <span className="font-pink">Projects</span> to work and collaborate on.
                        </p>
                        <p className="margin-top-46">
                        If you have any <span className="font-pink">Interesting Opportunities</span> you’d love for me to take a part in or even just <span className="font-pink">Chat</span>, <span className="font-pink">Contact</span> me on any of these <span className="font-pink">Platforms</span>.
                        </p>
                    </div>
                    <ContactIcons />
                </div>
