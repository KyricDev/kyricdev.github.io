...
export function AboutMe() {
  ...
  return (
    <div id="aboutme" className="relative">
      <BlurredMovingCircle />
      <div className="gap-20 ml-80 h-screen flex flex-col items-center justify-center px-50">
        <img
          className="size-64 rounded-full border-primary border-2"
        ...
        <div className="flex text-white gap-5 items-center">
          <a href={Links.github} target="_blank">
            <SiGithub className="hover:text-primary transition-all duration-200 cursor-pointer hover:scale-125 text-5xl" />
          </a>
          <a href={Links.linkedIn} target="_blank">
            <FaLinkedin className="hover:text-primary transition-all duration-200 cursor-pointer hover:scale-125 text-5xl" />
          </a>
          <Tooltip>
            <TooltipTrigger>
              <LuMail
                className="hover:text-primary transition-all duration-200 cursor-pointer hover:scale-125 text-5xl"
